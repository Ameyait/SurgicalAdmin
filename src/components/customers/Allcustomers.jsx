      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="mt-1 text-[12px] text-slate-500 ml-4">
            ...
            {summary?.vip_customers || 0} VIPs
          </p>
        </div>

        <button className="h-10 px-4 ml-2 mr-6 bg-white border border-slate-200 rounded-xl shadow-sm flex items-center gap-2 text-sm font-medium">
          <Download size={16} />
          Export
        </button>
      </div>
