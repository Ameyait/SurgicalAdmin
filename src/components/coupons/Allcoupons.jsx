            ...
            <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                    {couponData?.map((coupon) => (
                        <div
                            key={coupon.id}
                            className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 h-[260px] relative overflow-hidden"
                        >
                            ...
                            <div className="flex items-center justify-between mb-3">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span
                                        className={`px-2 py-1 rounded-full text-xs font-medium ${coupon.is_active
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className={`w-8 h-5 rounded-full relative transition-all duration-300 ${coupon.is_active
                                        ? "bg-blue-600"
                                        : "bg-slate-300"
                                        }`}
                                >
                                    <span
                                        className={`absolute top-1 w-3 h-3 bg-white rounded-full transition-all duration-300 ${coupon.is_active
                                            ? "right-1"
                                            : "left-1"
                                            }`}
                                    />
